...
public class C_ParticipantHomeOld extends AppCompatActivity implements LoadingActivity {
    ...
    private void refresh() {
        ...
        //Question thisQuestion = thisQuiz.getQuestion(roundSpinner.getPosition(),questionSpinner.getQuestionNr());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.refresh:
                QuizLoader quizLoader = new QuizLoader(C_ParticipantHomeOld.this, thisQuiz.getListData().getSheetDocID());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_act_participant_home_old);
        //Set the action bar
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                GoogleAccessSet submitAnswers = new GoogleAccessSet(C_ParticipantHomeOld.this, scriptParams, thisQuiz.getAdditionalData().getDebugLevel());
                submitAnswers.setData(new LoadingListenerNotify(C_ParticipantHomeOld.this, thisQuiz.getMyLoginentity().getName(),
