...
/**
 * Home page for the messages screen, used by bar responsible and juror. Allows to answer remarks from the teams.
 */
public class C_MessagesHome extends MyActivity implements LoadingActivity {
