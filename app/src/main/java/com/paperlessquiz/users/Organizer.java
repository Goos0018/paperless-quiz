...
public class Organizer extends User {
    ...
    public Organizer(int idQuiz, int idUser, int userNr, int userType, int userStatus, String name, int totalDeposits) {
    ...
    public Organizer(int organizerNr){
        super(MyApplication.theQuiz.getListData().getIdQuiz(),0,organizerNr, QuizDatabase.USERTYPE_RECEPTIONIST,QuizDatabase.USERSTATUS_NOTPRESENT,"EMPTY",0);
    }
